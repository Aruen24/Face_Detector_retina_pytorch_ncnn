...
void Detector::Detect(cv::Mat& bgr, std::vector<bbox>& boxes)
{
    ...
    //// loc
    //ex.extract("output0", out);//face

    //// class
    //ex.extract("530", out1);//face

    ////landmark
    //ex.extract("529", out2);//face

    //// loc
    //ex.extract("output0", out);//retinaface-m0.25

    //// class
    //ex.extract("586", out1);//retinaface-m0.25

    ////landmark
    //ex.extract("585", out2);//retinaface-m0.25

    // loc
    ex.extract("output0", out);//retinaface-r50

    // class
    ex.extract("833", out1);//retinaface-r50

    //landmark
    ex.extract("832", out2);//retinaface-r50
